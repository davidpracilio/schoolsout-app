    ...
    <div class="card-content">
      ...
      <div class="card-meta">
        ...
        <span class="meta-item">
          ...
          <a :href="activity.bookingUrl && !activity.bookingUrl.includes('example.com') ? activity.bookingUrl : `https://www.google.com/search?q=${encodeURIComponent(activity.name)}`" target="_blank" @click.stop class="meta-text">{{ activity.bookingUrl && !activity.bookingUrl.includes('example.com') ? 'Visit' : 'Search' }}</a>
        </span>
      </div>
    </div>
